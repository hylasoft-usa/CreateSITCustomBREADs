...
{
    /// <summary>
    ///     An extended ASP.NET button requiring a confirmation in order to post back page    /// 
    /// </summary>
    /// <remarks>
    ...
    [Description("An extended ASP.NET link button requiring a confirmation in order to post back page")]
